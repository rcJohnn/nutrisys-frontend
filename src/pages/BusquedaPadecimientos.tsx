...
const BusquedaPadecimientos: React.FC = () => {
  ...
  const seleccionarPaciente = (paciente: Usuario) => {
    setSearchTerm('');
    setShowResults(false);
    navigate(`/usuarios/padecimientos/${paciente.Id_Usuario}`);
  };
    ...
    <div className="busqueda-paciente-page">
      ...
      <div className="bp-info-card">
        ...
        <div className="bp-info-content">
          <h4>Gestión de Padecimientos</h4>
          <p>Seleccione un paciente para asignar o desasignar padecimientos a su historial clínico.</p>
        </div>
      </div>
    </div>
  );
...
export default BusquedaPadecimientos;
